...
TEXT_CATEGORIES = OrderedDict({
    ...
    ('fair_use_selected', '✅ درخواست استفاده از حجم منصفانه برای سرویس شما ثبت شد و به ادمین اطلاع داده شد.'),
        ('fair_use_approved', '✅ درخواست مصرف منصفانه شما تأیید شد. می‌توانید به استفاده از سرویس ادامه دهید.'),
        ('fair_use_rejected', '❌ درخواست مصرف منصفانه شما توسط ادمین رد شد. برای ادامه، لطفاً یک سرویس جدید تهیه کنید.'),
        ('fair_use_admin_request', '⚖️ درخواست استفاده از حجم منصفانه\n\n👤 مشتری: {customer_name}\n🔗 یوزرنیم: @{username}\n🆔 آیدی: {telegram_id}\n\n📦 بسته: {plan}\n📌 نام سرویس: {service_name}\n🆔 شناسه سرویس: {service_id}\n\n📊 مصرف فعلی: {used}\n⚖️ سقف مصرف منصفانه: {fair_use_gb} گیگابایت\n📅 انقضا: {expiry}\n\nکاربر درخواست ادامه استفاده از سرویس با سهمیه مصرف منصفانه را ثبت کرده است.'),

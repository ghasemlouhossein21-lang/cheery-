...
async def _log_fulfilled_order(
    ...
    # username باید از اطلاعات موجود سفارش/کاربر خوانده شود؛ فراخوانی
    # alerts.fetch_username در نسخه قبلی اصلاً تابعی تعریف‌شده نداشت و باعث می‌شد
    # کل لاگ قبل از رسیدن به کانال متوقف شود.
